...
class karyawan extends CI_Controller
{
	...
	function __construct()
	{
		...
		if($this->session->userdata('status') != 'is_login') redirect('login');
	}
	...
	function index() {
		...
		$this->template->write_view('content', 'karyawan/mypage', $data, true);
	...
	function table_exp() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_exp', $data, true);
	...
	function table_stock() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_stock', $data,  true);
	...
	function form_cat() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/form_cat', '', true);
	...
	function form_unit() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/form_unit', '', true);
	...
	function form_med() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/form_med', $data, true);
	...
	function table_med() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_med', $data, true);
	...
	function table_unit() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_unit', $data, true);
	...
	function invoice_report() {		
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/invoice_report', true);
	...
	function purchase_report() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/purchase_report', true);
	...
	function report() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/report', $data, true);
	...
	function table_cat() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_cat', $data, true);
	...
	function table_sup() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_sup', $data, true);
	...
	function form_sup() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/form_sup', '', true);
	...
	function form_invoice() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/form_invoice', $data, true);
	...
	function form_purchase() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/form_purchase', $data, true);
	...
	function table_purchase() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_purchase', $data, true);
	...
	function form_customer() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/form_customer', '', true);
	...
	function table_customer() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_customer', '', true);
	...
	function table_invoice() {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/table_invoice', $data, true);
	...
	function add_invoice(){
		...
		redirect('karyawan/table_invoice');
	}
	...
	function add_purchase(){
		...
		redirect('karyawan/table_purchase');
	...
	function invoice_page($ref) {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/invoice', $data, true);
	...
	function purchase_page($ref) {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/purchase', $data, true);
	...
	function edit_form_cat($id_kat) {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/edit_form_cat', $data, true);
	...
	function edit_form_med($id_obat) {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/edit_form_med', $data, true);
	...
	function edit_form_sup($id_pem) {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/edit_form_sup', $data, true);
	...
	function edit_form_unit($id_unit) {
		...
		$this->template->write('header', 'Sistem Informasi Apotek');
		$this->template->write_view('content', 'karyawan/edit_form_unit', $data, true);
