  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <form action="<?php echo base_url(). 'karyawan/update_medicine'; ?>" method="post" class="form-horizontal form-label-left" novalidate>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="warna">Warna</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="warna" name="warna" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $m->warna ?>">
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
              <a href="<?php echo base_url('karyawan/table_med') ?>"><button type="button" class="btn btn-danger">Batal</button></a>
