      ...
      <div class="x_content">
       ...
       <form action="<?php echo base_url(). 'admin/add_purchase'; ?>" method="post" class="form-horizontal form-label-left" novalidate>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div>
                  <input type="text" name="tgl_beli" id="tgl_beli" class="form-control" value="<?php date_default_timezone_set('Asia/Jakarta'); echo date('d-m-Y H:i:s'); ?>" required="required" readonly>
              </div>
            </div>
          </div>
