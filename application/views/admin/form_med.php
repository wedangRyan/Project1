    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        <div class="item form-group">
            ...
            <input type="text" id="id_obat" name="id_obat" required="required" data-validate-minmax="0,1000" class="form-control col-md-7 col-xs-12" value="BRO<?php echo sprintf("%04s", $checkodeobat) ?>" readonly>
            </div>
          </div>
